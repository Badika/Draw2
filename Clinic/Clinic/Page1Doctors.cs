...
namespace Clinic
{
    public class Page0Patients : FragmentBase
    {
 
        public Page0Patients(Activity parent)
           : base(parent)
        {
        ...
        {
            view = inflater.Inflate(Resource.Layout.patients_page, container, false);
